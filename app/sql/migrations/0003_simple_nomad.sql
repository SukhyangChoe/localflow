...
ALTER TABLE "notifications" ADD CONSTRAINT "notifications_board_id_boards_board_id_fk" FOREIGN KEY ("board_id") REFERENCES "public"."boards"("board_id") ON DELETE cascade ON UPDATE no action;